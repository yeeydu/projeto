...
<footer class="text-center text-lg-start text-dark" style="background-color: #ECEFF1">
    ...
    <section class="d-flex justify-content-between p-4 text-white" style="background-color: #443549">
        <!-- Left -->
        ...
        <div class="col-md-4 col-lg-4 col-xl-3 mx-auto mb-3">
            ...
            <a class="footer__social-link text-white" href="https://www.facebook.com/diogopintoweddings"
                target="_blank"><i class="fab fa-facebook"></i></a>
            <a class="footer__social-link text-white" href="https://www.instagram.com/diogopintophoto.video"
                target="_blank">
                <i class="fab fa-instagram"></i></a>
            <a class="footer__social-link text-white" href="https://www.youtube.com/channel/UC-xSYYun9UPBDbMgf9_z_0w"
                target="_blank">
